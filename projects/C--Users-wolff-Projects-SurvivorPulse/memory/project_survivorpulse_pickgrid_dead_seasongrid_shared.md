...
metadata: 
  ...
  modified: 2026-08-23T16:43:48.877Z
---
...
⚠️ **This memory is 20+ days old as of 2026-08-23, and its own text documents three architecture
changes to this exact area (SST-1001, SST-1026, SST-1043) in the five days before it was even
written.** An area with that recent a churn rate is a poor candidate to treat as settled fact this
long after the last verification — re-run the whole-repo grep this memory describes
(`PickGrid.tsx` production renderers, `SeasonGridSection`/`WeekViewSection` render sites) before
relying on the specific claims here, rather than citing this file alone.
