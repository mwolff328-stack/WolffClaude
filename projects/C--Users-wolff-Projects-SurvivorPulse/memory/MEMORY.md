...
- [My Strategy wizard is unreachable](project_survivorpulse_my_strategy_wizard_unreachable.md) — `/strategy` redirects to `/game-plan`; founder-confirmed 2026-08-03 no plans to revive it, Step1-5*.tsx are deletion candidates.
