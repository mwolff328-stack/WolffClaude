...
- [My Strategy wizard: deleted 2026-08-03](project_survivorpulse_my_strategy_wizard_unreachable.md) — my-strategy.tsx/Step1,2,5 gone (SST-1261); Step3/4/StrategyWizardContext/StrategySelectionModal survive, still live via /tools/*.
- [TanStack Query keys hash by value](project_survivorpulse_tanstack_query_keys_hash_by_value.md) — two hooks in different files with the same literal queryKey share ONE cache entry; check for accidental key equality, don't assume file-separation means independence.
