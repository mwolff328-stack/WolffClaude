...
- [Stale SPA bundle after publish](project_survivorpulse_stale_spa_bundle_after_publish.md) / [prod smoke access](project_survivorpulse_production_smoke_access.md) — use host not current_database().
- [Deployed dev app URL](project_survivorpulse_deployed_dev_url.md) — ask founder if stale / [legacy Repl](project_survivorpulse_legacy_repl_is_rollback_only.md) — rollback-only, .com is v1.
...
- [SST-1247 residual gaps](project_survivorpulse_sst1247_residual_gap_rulings.md) — RESOLVED / [Replit forwards X-Forwarded-Host](project_survivorpulse_replit_edge_passes_forwarded_host.md), not mitigation.
...
- [Dual app-entry trap](project_survivorpulse_dual_app_entry_trap.md) — prod App-v1.tsx, dev App.tsx / [login ?next= same-origin only](project_survivorpulse_login_next_param_is_same_origin_only.md) / [late-auth persistence trap](project_survivorpulse_per_user_client_persistence_late_auth_trap.md).
...
- [Notion "outage" is connector-specific](project_survivorpulse_notion_comment_outage_is_connector_specific.md) / [Chrome composer can corrupt last comment](project_survivorpulse_notion_comments_via_chrome_composer.md).
...
- [Dead page's route still load-bearing](project_survivorpulse_dead_page_live_redirect_route.md) / [cockpit wrapper global-nav trap](project_survivorpulse_pool_cockpit_wrapper_global_nav_trap.md).
...
- [SST number is auto-increment](project_survivorpulse_notion_sst_id_is_auto_increment.md) / [PickGrid.tsx dead](project_survivorpulse_pickgrid_dead_seasongrid_shared.md).
