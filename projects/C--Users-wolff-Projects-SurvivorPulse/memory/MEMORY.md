...
- [My Strategy wizard is unreachable](project_survivorpulse_my_strategy_wizard_unreachable.md) — `/strategy` permanently redirects to `/game-plan`; Step1-5*.tsx are dead code from a real-user standpoint despite active maintenance.
